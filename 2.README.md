...
The high-frequency component is incorporated into the reward function to discourage rapid, oscillatory control actions. This helps the model learn smoother and more physically realistic control strategies.

The total reward is defined as:

$$
R_{\text{total}} = R_{\text{base}} - \lambda_{\text{penalty}} \cdot \text{hf\_score}
$$
